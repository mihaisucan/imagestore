...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field related_articles on 'Image'
        db.create_table('imagestore_image_related_articles', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('image', models.ForeignKey(orm['imagestore.image'], null=False)),
            ('entry', models.ForeignKey(orm['zinnia.entry'], null=False))
        ))
        db.create_unique('imagestore_image_related_articles', ['image_id', 'entry_id'])


    def backwards(self, orm):
        # Removing M2M table for field related_articles on 'Image'
        db.delete_table('imagestore_image_related_articles')
    ...
    models = {
        ...
        'imagestore.image': {
            ...
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'related_articles': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'related_images'", 'blank': 'True', 'to': "orm['zinnia.Entry']"}),
            'related_images': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'related_images_rel_+'", 'blank': 'True', 'to': "orm['imagestore.Image']"}),
