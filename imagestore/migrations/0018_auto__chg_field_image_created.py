...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('imagestore_image', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Image.created'
        db.alter_column('imagestore_image', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
    ...
    models = {
        ...
        'imagestore.image': {
            ...
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'related_images': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'related_images_rel_+'", 'to': "orm['imagestore.Image']"}),
